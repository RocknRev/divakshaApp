...
import com.rak.distribio.dto.OrderRequest;
import com.rak.distribio.dto.OrderResponse;
import com.rak.distribio.dto.PagedResponse;
import com.rak.distribio.entity.Order;
import com.rak.distribio.service.OrderService;
	...
	public ResponseEntity<OrderResponse> createOrder(@Valid @RequestBody OrderRequest request) {
		try {
			Order order = orderService.createOrder(
				...
				request.getAmount(),
				request.getDeliveryName(), request.getDeliveryPhone(), request.getDeliveryAddress(), request.getQuantity()
			);
