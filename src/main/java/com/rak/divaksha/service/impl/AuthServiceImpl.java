...
import com.rak.divaksha.repository.OtpLoggerRepository;
...
public class AuthServiceImpl implements AuthService {
	...
	private final OtpLoggerRepository otpLoggerRepository;
	private final MailServiceImpl mailService;

	public AuthServiceImpl(UserRepository userRepository, PasswordEncoder passwordEncoder, JwtUtil jwtUtil, OtpLoggerRepository otpLoggerRepository, MailServiceImpl mailService) {
		this.userRepository = userRepository;
		this.passwordEncoder = passwordEncoder;
		this.jwtUtil = jwtUtil;
		this.otpLoggerRepository = otpLoggerRepository;
